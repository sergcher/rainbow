...
def generate_pdf():
    ...
    for apartment in apartments:
        ...
        p.drawString(537, h - 145 - y_offset, f"{apartment_fee.total}")
        ...
        p.drawString(384, h - 158 - y_offset, f"{apartment_fee.maintenance_total}")
        p.rect(431, h - 161 - y_offset, 54, 13)
        p.drawString(457, h - 158 - y_offset, f"-")
        p.rect(485, h - 161 - y_offset, 50, 13)
        p.drawString(503, h - 158 - y_offset, f"{apartment_fee.recalculation}")
        p.rect(535, h - 161 - y_offset, 50, 13)
        p.drawString(537, h - 158 - y_offset, f"{apartment_fee.electricity}")
        ...
        p.drawString(537, h - 236 - y_offset, f"")
